  ...
  for (const spec of PORTFOLIO_SPECS) {
    ...
    await prisma.portfolio.create({
      data: {
        ...
        commissionsYear1: money(Math.round(annualCommissions * 0.88 * 100) / 100),
        commissionsYear2: money(Math.round(annualCommissions * 0.94 * 100) / 100),
        commissionsYear3: money(annualCommissions),
        recurrentCommissionShare: "0.7200",
        managedAnnualPremium: money(Math.round((annualCommissions / 0.18) * 100) / 100),
