...
/** Flux d’annonces en direct, à droite du hero. */
  ...
  return (
    <div className="relative mx-auto w-full max-w-md lg:max-w-none">
      ...
      <div className="rounded-[1.75rem] border border-line bg-paper p-5 shadow-[0_24px_60px_-28px_rgba(17,24,39,0.28)] sm:p-6">
        ...
        <p className="mt-1 text-[13px] text-muted">Sous alias. Ni raison sociale, ni commune.</p>
            ...
            rows.map((item) => (
              <li key={item.id}>
                <Link
                  ...
                  className="flex items-center justify-between gap-3 rounded-2xl border border-line bg-page px-4 py-3.5 hover:border-indigo-line"
                >
